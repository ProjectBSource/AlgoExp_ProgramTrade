...
class ConnectToIBAPIandPlaceOrder:
    app = None
    def __init__(self):
    ...
    def run(self):
        ...
        if args.global_cancel:
            self.app.globalCancelOnly = True
        # ! [connect]
        self.app.connect("127.0.0.1", args.port, clientId=0)
        # ! [connect]
        print("serverVersion:%s connectionTime:%s" % (self.app.serverVersion(), self.app.twsConnectionTime()))
